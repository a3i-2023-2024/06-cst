...
This tutorial in particular tackles techniques to incorporate constraints in Machine Learning, focussing on shape constraints in Lattice Models and Lagrangian (a.k.a. regularization-based) approaches in differentiable ML.
...
```sh
git clone https://github.com/a3i-2023-2024/06-cst
```
